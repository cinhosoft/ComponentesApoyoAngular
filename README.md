...
export class UsuarioService {
  ...
  guardarUsuario(id:string, username:string){
    ...
    sessionStorage.setItem('username',idUsuario)
    sessionStorage.setItem('nombrCompleto',nombreUsuario)
  ...
  getUsuario(id:String): Observable<Usuario>{
    return this._http.get<Usuario>(`${this.url}user/${id}`)
  }

  listarUsuarios():Observable<any>{
    console.log("Traer Equipos");
    //this.agregarAuthorizationHeader();
    return this._http.get<Usuario>(this.url+'user', { headers:  this.httpHeaders});
   }
  ...
  delete(id:String): Observable<Usuario> {
   return this._http.delete<any>(this.url+'user/'+`${id}`, {headers:  this.httpHeaders});
